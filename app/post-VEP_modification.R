...
# 
# input = "/home/gonzalo/tblab/mnt/tblab/gonzalo/pruebas_vep_priorr/example_dir/22-2341.vep.tsv"
# output = "/home/gonzalo/tblab/mnt/tblab/gonzalo/pruebas_vep_priorr/example_dir/22-2341.pvm.tsv"
# dbNSFPgenepath = "/home/gonzalo/tblab/mnt/tblab/gonzalo/pruebas_vep_priorr/priorr_shared_folder/custom/dbNSFP4.3_gene.complete.pvm.txt"
# dict_region_path = "/home/gonzalo/tblab/home/gonzalo/nextflowtest/priorr_annot_docker/app/dict_region.csv"
# omim_path = NULL
# skip = 128
# automap_path = "/home/gonzalo/tblab/mnt/tblab/gonzalo/pruebas_vep_priorr/example_dir/"
# maf = 0.1
...
vep = vep[is.na(vep$gnomADe_AF_popmax) | as.numeric(vep$gnomADe_AF_popmax) < as.numeric(maf),]
print(nrow(vep))
...
for (sample in samples){
  tryCatch(
    ...
    error=function(e) print(paste0("There is no sample information for: ", sample)), 
    warning=function(e) print(paste0("There is no sample information for: ", sample))
  )
